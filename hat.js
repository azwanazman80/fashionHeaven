...
import { loadGLTF, loadTexture } from "/xampp/htdocs/wesiteAR/libs/loader.js"; 
...
document.addEventListener('DOMContentLoaded', () => { 
  const start = async () => { 
    ...
    // Apply relative transformation in the rendering loop
    await mindarThree.start(); 
    renderer.setAnimationLoop(() => { 
      faceMesh.position.set(0, 400, 0); // Adjust the y position slightly upwards
