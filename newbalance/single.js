...
document.addEventListener('DOMContentLoaded', () => {
    const start = async () => {
        ...
        const mindarThree = new window.MINDAR.IMAGE.MindARThree({
            ...
            imageTargetSrc: '../../assets/targets/newbalance/newbalance.mind'
        });
        ...
        // Load a 3D model (newbalance) using the loadGLTF function and configure its scale and position
        const newbalance = await loadGLTF('../../assets/models/newbalance/scene.gltf');
        newbalance.scene.scale.set(0.2, 0.2, 0.2);
        newbalance.scene.position.set(0, -0.4, 0);
        newbalance.scene.userData.clickable = true; // Mark the model as clickable

        // Add an AR anchor for the newbalance and attach the newbalance model to it
        const newbalanceAnchor = mindarThree.addAnchor(0);
        ...
        const audio = await loadAudio('../../assets/sounds/newbalance/newbalancevoice.wav');
        ...
        document.body.addEventListener('click', (e) => {
            ...
            if (intersects.length > 0) {
                ...
                if (o.userData.clickable && o === newbalance.scene) {
